...
namespace ArangoDB.Client.Common.Remotion.Linq.EagerFetching
{
  ...
  /// where the <see cref="FetchRequestBase"/> occurred in the <see cref="ArangoDB.Client.Common.Remotion.Linq.QueryModel.ResultOperators"/> list of the <see cref="SourceItemQueryModel"/>. From
