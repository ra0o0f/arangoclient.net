...
namespace ArangoDB.Client
{
    public interface IDocumentCollection<T> : IArangoCollection<T>
    {
        ...
        Task<DocumentIdentifierResult> SaveAsync(object document, bool? createCollection = null, bool? waitForSync = null);
        ...
        /// <param name="waitForSync">Wait until document has been synced to disk</param>
        /// <returns>Document identifiers</returns>
        DocumentIdentifierResult Save(object document, bool? createCollection = null, bool? waitForSync = null);
    }
}
