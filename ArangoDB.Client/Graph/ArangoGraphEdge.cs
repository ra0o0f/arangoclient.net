...
namespace ArangoDB.Client.Graph
{
    public class ArangoGraphEdge : IArangoGraphEdge
    {
        ...
        public IDocumentIdentifierResult Insert(string from, string to, object document, bool? waitForSync = null, Action<BaseResult> baseResult = null)
        {
            return InsertAsync(from, to, document, waitForSync, baseResult).ResultSynchronizer();
        }
    ...
    public class ArangoGraphEdge<T> : IArangoGraphEdge<T>
    {
        ...
        /// <param name="baseResult"></param>
        /// <returns>DocumentIdentifierResult</returns>
        public IDocumentIdentifierResult Insert<TFrom, TTo>(string from, string to, object document, bool? waitForSync = null, Action<BaseResult> baseResult = null)
        {
            return InsertAsync<TFrom, TTo>(from, to, document, waitForSync, baseResult).ResultSynchronizer();
        }
