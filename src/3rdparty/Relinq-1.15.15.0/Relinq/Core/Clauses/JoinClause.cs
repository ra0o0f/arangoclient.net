...
namespace ArangoDB.Client.Common.Remotion.Linq.Clauses
{
  ...
  public class JoinClause : IBodyClause, IQuerySource
  {
    ...
    [DebuggerDisplay ("{ArangoDB.Client.Common.Remotion.Linq.Clauses.ExpressionTreeVisitors.FormattingExpressionTreeVisitor.Format (InnerSequence),nq}")]
    ...
    [DebuggerDisplay ("{ArangoDB.Client.Common.Remotion.Linq.Clauses.ExpressionTreeVisitors.FormattingExpressionTreeVisitor.Format (OuterKeySelector),nq}")]
    ...
    [DebuggerDisplay ("{ArangoDB.Client.Common.Remotion.Linq.Clauses.ExpressionTreeVisitors.FormattingExpressionTreeVisitor.Format (InnerKeySelector),nq}")]
    ...
    /// <summary>
    /// Accepts the specified visitor by calling its <see cref="IQueryModelVisitor.VisitJoinClause(ArangoDB.Client.Common.Remotion.Linq.Clauses.JoinClause,ArangoDB.Client.Common.Remotion.Linq.QueryModel,int)"/> 
    /// method.
    /// </summary>
