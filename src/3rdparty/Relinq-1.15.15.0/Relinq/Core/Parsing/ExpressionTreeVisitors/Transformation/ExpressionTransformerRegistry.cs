...
using ArangoDB.Client.Common.Remotion.Linq.Collections;
using ArangoDB.Client.Common.Remotion.Linq.Parsing.ExpressionTreeVisitors.Transformation.PredefinedTransformations;
using Remotion.Utilities;

namespace ArangoDB.Client.Common.Remotion.Linq.Parsing.ExpressionTreeVisitors.Transformation
{
  /// <summary>
